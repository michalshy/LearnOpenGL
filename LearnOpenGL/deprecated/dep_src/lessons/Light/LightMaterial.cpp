...
void LightMaterial::run()
{
	...
	//define real material, here - obsidian
	glm::vec3 diffuseColor(0.18275f, 0.17f, 0.22525f);
	glm::vec3 ambientColor(0.05375f, 0.05f, 0.06625f);
	glm::vec3 specularColor(0.332741f, 0.328634f, 0.346435f);

	lighting.use();
	// material properties
	lighting.setVec3("material.ambient", ambientColor);
	lighting.setVec3("material.diffuse", diffuseColor);
	lighting.setVec3("material.specular", specularColor); // specular lighting doesn't have full effect on this object's material
	lighting.setFloat("material.shininess", 38.4f);
