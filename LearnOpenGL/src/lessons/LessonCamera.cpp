...
static glm::vec3 cameraUp = glm::vec3(0.f, 1.f, 3.f);
...
void LessonCamera::init()
{
	...
	unsigned char* data;
	data = stbi_load("tex\\container.jpg", &width, &height, &nrChannels, 0);
	if (data)
	{
...
void LessonCamera::additional_input()
{
